...
class MTSLauncher(testcase.TestCase):
    ...
    def check_enabled_mts_test_cases(self, enabled_testcases):
        ...
        if len(enabled_testcases) > 0:
            # Verify if the MTS test case exists in the whole list of test cases
            # declared in the test XML file
    ...
    def execute(self, **kwargs):
        ...
        try:
            ...
            max_duration = kwargs["max_duration"] if "max_duration" in kwargs else None
            store_method = kwargs[
            ...
            enabled_testcases = kwargs["testcases"] if "testcases" in kwargs else []
            ...
            cmd = ("cd {} && ./startCmd.sh {} {} -sequential -levelLog:{} -storageLog:{}"
            ...
            self.__logger.info("MTS statistics output dir: %s ", self.mts_stats_dir)
            ...
            with open(self.result_file, 'w') as f_stdout:
                ...
                try:
                    ...
                    process.kill()
                    self.__logger.info("Killing MTS process after %d second(s).",
                                       max_duration)
                    return 3
    ...
    def run(self, **kwargs):
        ...
        try:
            ...
            # Do something only if there are some MTS test cases in the test file
            if nb_testcases > 0:
                if self.execute(**kwargs) == 0:
                    ...
                    try:
                        ...
                        self.__logger.exception(
                            "Cannot parse result file $MTS_HOME/logs/testPlan.csv")
                        exit_code = testcase.TestCase.EX_RUN_ERROR
        except Exception:  # pylint: disable=broad-except
