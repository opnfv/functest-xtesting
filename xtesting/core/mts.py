...
class MTSLauncher(testcase.TestCase):
    ...
    def parse_xml_test_file(self, xml_test_file):
        ...
        try:
            ...
            self.testcases = root.xpath('//test//testcase')
    ...
    def run(self, **kwargs):
        ...
        try:
            ...
            # Do something only if there are some MTS test cases to launch
            if nb_testcases > 0:
