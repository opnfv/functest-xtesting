...
class MTSLauncher(testcase.TestCase):
    ...
    def __init__(self, **kwargs):
        ...
        self.mts_logs_dir = os.path.join(self.res_dir, 'mts_logs'+os.path.sep)
    ...
    def execute(self, **kwargs):
        ...
        try:
            ...
            store_method = kwargs["store_method"] if "store_method" in kwargs else "FILE"
            ...
            with open(self.result_file, 'w') as f_stdout:
                ...
                process = subprocess.Popen(
                    ...
                    stderr=subprocess.STDOUT, cwd=self.mts_install_dir)
